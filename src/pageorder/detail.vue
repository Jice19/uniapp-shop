...
// 获取最后一页
const lastPage = page.at(-1) as any
...
onReady(() => {
  ...
  // 动画效果,导航栏标题
  lastPage.animate('.navbar .title', [{ color: 'transparent' }, { color: '#000' }], 1000, {
...
<template>
  ...
  <view class="navbar" :style="{ paddingTop: safeAreaInsets?.top + 'px' }">
    <view class="wrap">
      <navigator v-if="page.length > 1"
        open-type="navigateBack"
        class="back icon-left"></navigator>
